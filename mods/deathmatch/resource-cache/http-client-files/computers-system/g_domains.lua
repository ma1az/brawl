local domains = {
	...
	{ fake = 'findbook.sa', real = 'findbook.brawlroleplay.com' },
...
-- we're using this list to allow wildcard requests for domains, for example visiting forums.brawlroleplay.com would ask for permission to visit 'brawlroleplay.com'
