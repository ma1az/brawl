...
function OnBtnRegister ()
	...
	playSoundFrontEnd ( 2 )
	--guiSetText(panel.login.error, "Please register on brawlroleplay.com/register.php")
end
...
function displayRegisterConpleteText(username)
    ...
    local temp = "Welcome to Brawl Roleplay! Your account has been successfully created. You can now enjoy all the features and services we offer. Feel free to explore and get started!"
    GUIEditor.label[1] = guiCreateLabel(8, 50, 339, 121+extend, "Your MTA account for '"..username.."' is ready for action!\n\n"..temp.."\n\nSincerely, \nBrawl Roleplay Community Brawl Roleplay Development Team\"", false, GUIEditor.window[1])
