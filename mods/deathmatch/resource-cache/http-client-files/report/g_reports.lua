...
function getReportInfo(row, element)
	...
	for k,v in ipairs(staff) do
		if v == 39 or v == 43 then
			...
			if vcount==0 then
				return false, "There is currently no VCT Members online. Contact them here: http://forums.brawlroleplay.com/forms.php?do=form&fid=42"
		...
		elseif v == 32 then
			...
			if scount==0 then
				return false, "There is currently no members of the Scripting team online. Use Support Center at www.brawlroleplay.com/support.php"
