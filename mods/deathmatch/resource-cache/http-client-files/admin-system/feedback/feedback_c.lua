...
function openFeedBackForm(target)
	...
	gui.label[2] = guiCreateLabel(14, 299, 313, 53, "Your time and efforts to complete this feedback form are much appreciated. Your input will be kept strictly confidential, and will be used to continuously improve the staff team's service and support you receive from the Brawl Roleplay.", false, gui.window[1])
