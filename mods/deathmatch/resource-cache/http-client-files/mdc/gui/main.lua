...
function main ( warrants, apb, impounds, calls, anpr )
	closeMainW()
	--outputChatBox( "Experimental MDC system! Any feedback or bugs you find within this system please let us know via http://bugs.brawlroleplay.com/view.php?id=616 ASAP.", 255, 0, 0 )
