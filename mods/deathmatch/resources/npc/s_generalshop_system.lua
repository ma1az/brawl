...
addEventHandler( "shop:buy", resourceRoot, function( index )
	...
	_G['shop'] = shop
	if not shop then
		outputChatBox("Error " .. error .. "-NE, report at bugs.brawlroleplay.com.", client, 255, 0, 0 )
		return
	end
	...
	if not item then
		outputChatBox("Error " .. error .. "-NEI-" .. index .. ", report at bugs.brawlroleplay.com.", client, 255, 0, 0 )
		return
	end
