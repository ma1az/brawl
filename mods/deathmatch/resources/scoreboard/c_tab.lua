...
local CONFIG = {
    ...
    HEADER_COLOR                = {120, 105, 170, 230},-- Header background color
    ...
    SEPARATOR_COLOR             = {191, 94, 243, 255},-- Separator lines color
    SCROLL_COLOR                = {191, 94, 243, 180},-- Scroll bar color
    SCROLL_HOVER_COLOR          = {191, 94, 243, 230},-- Scroll bar hover color
...
local function drawServerInfo()
    ...
    local playerCountStr = "Players: " .. tostring(#g_players) .. "/" .. tostring(maxPlayers)
