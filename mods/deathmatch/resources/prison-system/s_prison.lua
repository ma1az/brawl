...
addEventHandler("removePrisoner", resourceRoot,
	function( removeid, fromGUI )
			...
			if result then
                ...
                outputChatBox("Error, PS#01. Report on Mantis: bugs.brawlroleplay.com", client, 255, 0, 0)
			end
		end
)
	...
	function( name, cell, days, hours, charges, fine, online )
		...
		if query then
			...
			if row then
				...
				outputChatBox("Error, PS#02. Report on Mantis: bugs.brawlroleplay.com", client, 255, 0, 0)
			end
		else
