...
function createForumThread(createInForumID, fTitle, fContent, ...)
	...
	-- 		<img alt="Brawl Roleplay.png" class="ipsImage" src="http://files.brawlroleplay.com/Logo/Brawl Roleplay.png">
	-- 		<p></p>
	...
	-- fetchRemote("https://forums.brawlroleplay.com/api/forums/topics?key="..key, options, forumCallback, {...})
end
