...
function pendingReportTimeout(id)
	if (reports[id]) then
		...
		outputChatBox("[" .. timestring .. "] If you still require assistance, please resubmit your report or visit our forums (http://forums.brawlroleplay.com).", reportingPlayer, 200, 240, 120)
		sortReports(false)
		updateReportCount()
	end
end]]
