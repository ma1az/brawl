...
function newCharacter_init()
	...
	setCameraMatrix(161.4620,  -91.3940,  1001.9050, 161.4620,  -89.3940,  1001.8050 )
	dummyPed = createPed(217, 161.404296875, -88.44296875, 1001.8046875)
	setElementInterior(dummyPed, 18)
	setElementInterior(getLocalPlayer(), 18)
	setPedRotation(dummyPed, 180.5)
