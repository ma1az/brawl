...
function resourceStart(resource)
	...
	setRuleValue("Website", "www.brawlroleplay.com")
...
function makeOwlName(thePlayer)
	setPlayerName(thePlayer, "Brawl.Player."..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
end
