...
blackFemales = {9, 10, 11, 13, 40, 41, 69, 148, 195, 215, 218, 304 }
whiteFemales = {31, 38, 39, 41, 53, 54, 77, 88, 89, 93, 129, 130, 151, 157, 172, 194, 196, 197, 211, 224, 225, 231, 232 }
...
addEventHandler('onClientGUIClick', label, function()
	local url = "http://dev.brawlroleplay.com"
