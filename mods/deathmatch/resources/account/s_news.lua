...
function patchNotes_update(player)
	callRemote("www.brawlroleplay.com/server/patchnotes.php", 
		function( title, text)
			if title == "ERROR" then
...
function adminRules_update(player)
	callRemote("www.brawlroleplay.com/server/adminrules.php", 
		function( title, text)
			if title == "ERROR" then
...
function gmRules_update(player)
	callRemote("www.brawlroleplay.com/server/gmrules.php", 
		function( title, text)
			if title == "ERROR" then
