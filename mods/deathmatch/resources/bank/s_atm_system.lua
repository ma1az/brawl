...
function applyForNewATMCard(replacingOldATMCard, limitType)
	...
	if not numSum then
		exports.hud:sendBottomNotification(source, "SQL Error", "An SQL Error CODE01 has occured in Bank System. Please report this on http://bugs.brawlroleplay.com")
		return false
	end
	...
	if not exports.global:giveItem(source, 150, numSum..";"..charID..";"..limitType) then
		exports.hud:sendBottomNotification(source, "Internal Error", "An SQL Error CODE0223 has occured in Bank System. Please report this on http://bugs.brawlroleplay.com.")
		return false
	end
	...
	if not makeNewCard then
		exports.hud:sendBottomNotification(source, "SQL Error", "An SQL Error CODE02 has occured in Bank System. Please report this on http://bugs.brawlroleplay.com.")
		return false
	end
...
function changePIN(theATM, enteredCode)
	...
	if not mysql:query_free("UPDATE `atm_cards` SET `card_pin`='"..enteredCode.."' WHERE `card_number`='"..cardNumber.."' ") then
		exports.hud:sendBottomNotification(source, "SQL Error", "An SQL Error CODE06 has occured in Bank System. Please report this bug on http://bugs.brawlroleplay.com")
		triggerClientEvent(source, "bank:respondToATMInterfacePIN", source, "An SQL Error CODE06 has occured in Bank System. Please report this bug on http://bugs.brawlroleplay.com", 255,0,0, "changedPIN", "failed" )
		return false
	end
