...
function F1RPhelp( key, keyState )
	...
	if not myWindow then
		...
		addEventHandler("onClientBrowserCreated", browser, function()
			if isBrowserDomainBlocked("docs.brawlroleplay.com") or isBrowserDomainBlocked("media.readthedocs.org") then
				requestBrowserDomains({"docs.brawlroleplay.com", "media.readthedocs.org"}, false, function(accepted, newDomains)
					loadBrowserURL(source, "http://docs.brawlroleplay.com/")
				end)
			else
				loadBrowserURL(source, "http://docs.brawlroleplay.com/")
			end
		...
		addEventHandler("onClientBrowserCreated", mantisBrowser, function()
			if isBrowserDomainBlocked("bugs.brawlroleplay.com") then
				requestBrowserDomains({"bugs.brawlroleplay.com"}, false, function(accepted, newDomains)
					...
					loadBrowserURL(mantisBrowser, "http://bugs.brawlroleplay.com/")
				end)
			else
				loadBrowserURL(source, "http://bugs.brawlroleplay.com/")
			end
		end)
