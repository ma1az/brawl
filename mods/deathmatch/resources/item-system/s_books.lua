function startBook(id, slot)
	if not tonumber(id) then
		outputChatBox("Error, BK#01. Report on bugs.brawlroleplay.com", client, 255, 0, 0)
		return
	end
	...
	if query then
		...
		if row then
			...
			triggerClientEvent(client, "PlayerBook", client, false, false, "Error, BK#02: Issue fetching book data! Report @ bugs.brawlroleplay.com")
		end
	else
		triggerClientEvent(client, "PlayerBook", client, false, false,"Error, BK#03: Issue Running SQL Query! Report @ bugs.brawlroleplay.com")
	end
